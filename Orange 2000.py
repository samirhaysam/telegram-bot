...
# =========================
START_TEXT = (
    "اهلا بيك في بوت 2000 ميجا  أورانج\n"
    "شرح طريقة الاستخدام:1. أرسل رقم هاتفك2. أرسل رمز حساب ماي أورانج  3. أرسل السيريال (اتصل بالكود ده واختار سيريال هيطلع معاك  #119#) 💸💰 يلا نبداء بسم الله ...دخل رقم تليفونك:"
)
